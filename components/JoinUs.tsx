      ...
      <div className="max-w-4xl mx-auto text-center -rotate-[0.5deg]">
        ...
        <div className="bg-gradient-to-br from-teal-100 via-amber-100 to-orange-100 rounded-lg p-8 md:p-12 shadow-lg">
          ...
          <a
            ...
            className="inline-block bg-teal-600 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-md hover:bg-teal-700 transition-colors cursor-pointer"
          >
            Kontakt aufnehmen
          </a>
        </div>
