      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-lg p-8 md:p-12 shadow-lg">
          <p className="text-lg md:text-xl text-gray-800 mb-6 leading-relaxed">
            ...
            echten Dorfgemeinschaft sein möchtest – beim Bruckfelder Narren-Club bist du willkommen.
          </p>
          <p className="text-lg text-gray-800 mb-6">
            Wir freuen uns über jedes neue Gesicht, das unsere Tradition und unser Vereinsleben
            bereichert. Komm einfach bei einer unserer Veranstaltungen vorbei,
            lerne uns kennen und schnupper rein!
          </p>
