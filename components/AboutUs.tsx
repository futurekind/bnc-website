      ...
      <div className="max-w-4xl mx-auto -rotate-[0.5deg]">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            ...
            sind ein fester Bestandteil unseres Dorfes. Gegründet aus der Liebe
            zur schwäbisch-alemannischen Fasnet und dem Wunsch, Tradition
            lebendig zu halten, gestalten wir seit vielen Jahren das
          ...
          <p>
            ...
            zusammengehalten – ob bei derFasnet, beim Gartenfest oder beim
          ...
          <p>
            ...
            Dabei setzen wir nicht nur auf die närrische Zeit, sondern begleiten
            das Jahr mit verschiedenen Aktivitäten, die das Miteinander fördern
            und für schöne gemeinsame Momente sorgen.
          </p>
          <p>
